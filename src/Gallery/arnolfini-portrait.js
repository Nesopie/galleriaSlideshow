...
const ArnolfiniPortrait = () => {
    return (
        ...
        perfect eye-witness in the truest sense of the term".`} authorImg={arnolfiniAuthor} year="1434" galleryImg={galleryImg} prevUrl="the-boy-in-the-red-vest" nextUrl="the-swing" source="https://en.wikipedia.org/wiki/Arnolfini_Portrait" currentItem={14}/>
    );
}
