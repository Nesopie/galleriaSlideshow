...
const TheNightCafe = () => {
    return (
        <PageTemplate paintingUrl={window.innerWidth >= 768 ? largeCafe : smallCafe} title="The Night Cafe" author="Vincent Van Gogh" desc={`The Night Café (French: Le Café de nuit) is an oil painting created by Dutch
