...
const Guernica = () => {
    return (
        ...
        sword, from which a flower grows.`} authorImg={guernicaAuthor} year="1937" galleryImg={galleryImg} prevUrl="girl-with-a-pearl-earring" nextUrl="penitent-magdalene" source="https://en.wikipedia.org/wiki/Guernica_(Picasso)" currentItem={3}/>
    );
}
